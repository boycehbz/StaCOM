    ...
    for epoch in range(num_epoch):
        ...
        if mode == 'train':
            ...
            if (epoch) % 1 == 0:
                ...
                logger.append([int(epoch + 1), lr, training_loss, testing_loss['contact_precision'], testing_loss['contact_recall'], testing_loss['contact_f1'], testing_loss['IDFAccuracy'], testing_loss['Penetration'], ])
