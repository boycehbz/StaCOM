...
class SDFLoss(nn.Module):
    ...
    def forward(self, vertices, obj_v, scale_factor=0.2, return_per_vert_loss=False, return_origin_scale_loss=False):
        ...
        for i in [0, 1]:
            ...
            vertices_local = (obj_v[:,None] - boxes_center[:, 1-i].unsqueeze(dim=1)) / boxes_scale[:, i].unsqueeze(dim=1)
