...
class base(data.Dataset):
    def __init__(self, train=True, dtype=torch.float32, data_folder='', name='', smpl=None):
        ...
        if self.smpl.model_type == 'smpl':
            self.smpl_female = SMPLModel(model_path='data/SMPL_FEMALE.pkl')
            self.smpl_male = SMPLModel(model_path='data/SMPL_MALE.pkl')
        else:
            self.smpl_female = SMPLXModel(model_path='data/SMPLX_FEMALE.pkl')
            self.smpl_male = SMPLXModel(model_path='data/SMPLX_MALE.pkl')
