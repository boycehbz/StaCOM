...
def parse_config(argv=None):
    ...
    parser.add_argument('--trainset',
                        default='CORE4D_real CORE4D_syn',
                        type=str,
                        help='trainset.')
    ...
    parser.add_argument('--model',
                        default='interhuman_flow_BPS_prior',
                        type=str,
    ...
    parser.add_argument('--model_type',
                        ...
                        type=str,
                        help='ee_train: encoder-encoder only, else ed_train.')
    parser.add_argument('--amp_use_pretrained',
                        default=False,
                        type=lambda x: x if isinstance(x, bool) else x.lower() in ['true', '1'],
                        help='Load pretrained AMP discriminator weights before training.')
    parser.add_argument('--amp_discriminator_ckpt',
                        default='',
                        type=str,
                        help='Checkpoint file containing pretrained AMP discriminator weights.')
    parser.add_argument('--interact_amp_use_pretrained',
                        default=False,
                        type=lambda x: x if isinstance(x, bool) else x.lower() in ['true', '1'],
                        help='Load pretrained AMP discriminator weights before training.')
    parser.add_argument('--interact_amp_discriminator_ckpt',
                        default='',
                        type=str,
                        help='Checkpoint file containing pretrained AMP discriminator weights.')
